...
#----------------------------------
# genome annotations:
k_pneum <- read.csv(file = "../../genome_annotation_csvs/EN16_annotation.csv", header=TRUE, sep=",")
average <- read.csv(file = "../../distance_csvs/EN16/distances_average_vs_EN16.csv", header=TRUE, sep=",")
...
distance_ave <- ordered_ave %>%
  ...
  geom_text_repel(
    ...
    color = "red") +
  theme_classic() +
  ggtitle("Average emb. vs Ecoli FHI_NMBU_10") +
  theme(
    legend.position = "none",
    panel.grid.major = element_line(color = "grey92", size = 0.5),
    panel.grid.minor.x = element_line(color = "grey92", size = 0.5))
